            ...
            <div class="col-sm-12">
                ...
                @else
                    <h5 style="font-size:20px;color:#5C5C5C;padding: 10px 0px"
                        class="">@lang('corals-marketplace-pro::labels.template.checkout_success.order_guest_email_sent',['email'=>isset($order) && $order->billing ?$order->billing['billing_address']['email']:''])</h5>
                    @endauth
            </div>
