...
Breadcrumbs::register('subscriptions', function ($breadcrumbs) {
    ...
    $breadcrumbs->push(trans('Subscriptions::module.subscription.title'), url(config('subscriptions.models.subscription.resource_url')));
});

Breadcrumbs::register('subscription_show', function ($breadcrumbs) {
