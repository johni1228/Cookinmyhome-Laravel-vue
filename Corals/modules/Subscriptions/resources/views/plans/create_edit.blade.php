            ...
            @component('components.box')
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! CoralsForm::number('notify_end_subscription_before','Subscriptions::attributes.plan.notify_end_subscription_before',false,null,
                                   ['help_text'=>'Subscriptions::attributes.plan.notify_end_subscription_before_help','step'=>1,'min'=>0]) !!}
