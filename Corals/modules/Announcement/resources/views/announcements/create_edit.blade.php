            ...
            @component('components.box')
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        {!! CoralsForm::select('roles[]','Announcement::attributes.announcement.roles', \Roles::getRolesList(), false, $announcement->exists ? $announcement->roles()->pluck('id')->toArray() : null, ['multiple'=>true], 'select2') !!}
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6">
